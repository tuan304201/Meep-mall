  ...
  <DefaultLayout>
    <div class="w-full">
      <div class="max-w-screen-2xl m-auto padding-16 mt-0 lg:mt-4">
        <a-row :gutter="14" style="margin-left: 0 !important">
          <a-col
            class="navbar"
            :lg="{ span: 4 }"
            :sm="{ span: 0 }"
          ...
          <a-col
            ...
            :xs="{ span: 24 }"
            :xl="{ span: 5 }"
            class="flex lg:flex-row flex-col justify-between gap-3"
          >
            <a-row :gutter="[14, 14]">
              <a-col
                :lg="{ span: 24 }"
        ...
        <div class="mt-5">
          <div class="bg-blue-500 text-xl font-extrabold p-4 rounded">
            <span class="uppercase text-white">Duy nhất hôm nay</span>
        ...
        <Category :title="`Thời trang`" :products="fashions" />
      </div>
    </div>
  </DefaultLayout>
</template>
...
import CardProductSale from '../components/CartProductSale.vue'
...
export default {
  ...
  data() {
    return {
      ...
      products: [
        { image: '', title: 'Thời trang' },
        { image: '', title: 'Thiết bị điện tử' },
        { image: '', title: 'Mỹ phẩm' },
        { image: '', title: 'Sức khoẻ' },
        { image: '', title: 'Gia dụng' },
        { image: '', title: 'Đồ chơi' },
      ],
      images: [
        {
